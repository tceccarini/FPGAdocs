...
\begin{enumerate}
    ...
    \item Write the extracted image to the \term{microSD} card (at least 8 GB) with a disk-imaging tool, e.g. \cmdpath{dd} on \term{Linux} or \gterm{balenaetcher}{balenaEtcher}\footnote{\glsentrydesc{balenaetcher}} on Windows/Mac.
