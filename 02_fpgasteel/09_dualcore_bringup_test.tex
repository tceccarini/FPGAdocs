...
\begin{enumerate}
    \item \term{OpenOCD} debugger halts \term{CPU0} over \term{JTAG} and loads the \term{ELF} file. \term{CPU1} is still held in hardware reset and has not executed anything at all yet.
