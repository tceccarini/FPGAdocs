...
Unchanged.\footnote{TODO [nota 150]: footnote text was lost when the source was copy-pasted -- please supply it.} Both \term{mSGDMA} cores, their descriptor memories, and every other \term{IP} core listed there are exactly the same hardware used by this project (the \term{Avalon-ST}/\term{Avalon-MM} conventions are those defined in \cite{AVALON-SPEC}).
...
\begin{figure}[htbp]
    ...
    \caption[Cortex-A9 MPU Subsystem Block Diagram]{Cortex-A9 MPU Subsystem Block Diagram, reproduced from \cite[Figure 10-2, p.~176]{CV-TRM}.\footnotemark{} Reported here for reference; not original work.}
