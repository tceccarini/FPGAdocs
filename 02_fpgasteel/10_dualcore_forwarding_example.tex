...
Unchanged.\footnote{TODO [nota 206]: footnote text was lost when the source was copy-pasted -- please supply it.} The hardware is exactly that of Cache Forwarding Example (the \term{Avalon-ST}/\term{Avalon-MM} conventions are those defined in \cite{AVALON-SPEC}, the \term{mSGDMA} extended descriptor format is documented in \cite{EP-IPUG}).
