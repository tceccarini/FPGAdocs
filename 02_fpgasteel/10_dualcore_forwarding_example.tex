...
Concrete |DualCoreJob| that splits one |SimpleFormatConverter|-style conversion into a top half and a bottom half, one per core, protected inheritance from |SimpleFormatConverter| since it reuses its per-format conversion helpers but does not expose |convert()|'s single-core meaning directly. Source: |DualCoreFormatConverter.{h,cpp}|.
